...
| `ALIPAY_NOTIFY_URL` | `https://你的域名.vercel.app/api/alipay/notify` | 异步回调地址 |
| `ALIPAY_RETURN_URL` | `https://你的域名.vercel.app/payment-success` | 同步回调地址 |
| `NODE_ENV` | `production` | 生产环境 |

**⚠️ 重要：**
- **必须替换** `https://你的域名.vercel.app` 为你的真实 Vercel 域名
...
**异步通知地址 (notify_url)**:
```
https://你的域名.vercel.app/api/alipay/notify
```

**同步返回地址 (return_url)**:
```
https://你的域名.vercel.app/payment-success
```
